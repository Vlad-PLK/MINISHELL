...
#    Updated: 2023/04/24 13:35:29 by mconreau         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PROJECT_ARCHIVES		:=	./libraries/libft/libft.a
PROJECT_DEPENDENCIES	:=	./libraries/libft
PROJECT_HEADERS			:=	./headers ./libraries/libft/headers ${HOME}/.brew/opt/readline/include
PROJECT_LIBRARIES		:=	${HOME}/.brew/opt/readline/lib

# > COMPILATION <<<<<<<<<<

COMPILER_PROGRAM		:=	gcc
COMPILER_PROGRAM_DEBUG	:=	-fsanitize=address,undefined
COMPILER_PROGRAM_FLAGS	:=	-o
COMPILER_PROGRAM_OTHER	:=	-lreadline
COMPILER_OBJECTS		:=	gcc
COMPILER_OBJECTS_FLAGS	:=	-g -Wall -Werror -Wextra
...
PROJECT_SOURCES			:=	$(addprefix $(FOLDER_SOURCES)/, main.c					\
							...
							parsing/executor/ft_main_execve.c						\
							parsing/executor/ft_execute_cmd.c						\
							parsing/executor/ft_set_and_close.c						\
							parsing/executor/ft_set_exit_status.c					\
							parsing/executor/ft_simple_builtin.c					\
							parsing/executor/ft_simple_cmd.c						\
							parsing/executor/ft_exec_cmd.c							\
							parsing/executor/ft_count_cmds.c						\
							parsing/executor/ft_which_builtin.c						\
							parsing/executor/ft_infile.c							\
							parsing/executor/debug.c								\
							parsing/executor/ft_outfile.c							\
							parsing/executor/ft_heredoc.c							\
							parsing/executor/ft_checking_status.c					\
							parsing/executor/piping/ft_pipe_cmd.c					\
							parsing/executor/piping/ft_pipe_close.c					\
							parsing/executor/piping/ft_pipe_creation.c				\
							parsing/executor/piping/ft_pipe_redirection.c			\
